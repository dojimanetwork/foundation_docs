...
7. **Deploy the Project**
   ...
   - The system prompts the user to **connect to the Dojima Wallet** to complete the deployment process.
...
![Details Screenshot](../images/omni-dapps/deployed-project-details
.png)